    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { icon: <Mail size={24} />, label: 'Email Us', value: 'contact@smartqueue.com' },
                  { icon: <Phone size={24} />, label: 'Call Us', value: '+91 98766 43210' },
                  { icon: <MapPin size={24} />, label: 'Visit Us', value: '123 Startup Lane, Tech Park, Bangalore' },
                ].map((item, i) => (
      ...
      <section className="bg-cta-gradient py-14 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <a href="mailto:contact@smartqueue.com" className="bg-white text-[var(--primary)] font-semibold px-8 py-3 rounded-xl hover:bg-blue-50 transition-all shadow-lg inline-block">
            Talk to Us
          </a>
        </div>
      </section>
